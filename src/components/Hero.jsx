...
const Hero = () => (
    ...
    <div className='flex flex-row justify-between items-center w-full'>
      <h1 className='flex-1 font-raleway font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px]
      leading-[75px]'>
    ...
    <h1 className='font-raleway font-semibold ss:text-[68px] text-[52px] text-white 
